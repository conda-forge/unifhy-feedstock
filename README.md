...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/unifhy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14814&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/unifhy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `unifhy` can be installed with:

```
conda install unifhy
```

It is possible to list all of the versions of `unifhy` available on your platform with:
